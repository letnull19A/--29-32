...
begin
  ...
  try
    Form11.DBImage1.Picture.LoadFromFile(ExtractFilePath(Application.ExeName) + IMAGES_PATH + '\' + image);
  except
    ShowMessage('Ошибка в загрузке изображения!');
  end;
end;
...
begin
  ...
  begin
    ...
    ShowImage(nFileName);
    ADODataSet1.FieldValues['Excitement'] := nFileName;
  end;
end;
